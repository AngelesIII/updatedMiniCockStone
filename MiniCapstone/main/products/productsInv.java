...
public class productsInv { //encapsulate data
    ...
    int expProductsNotifCount, emptyQuantityNotifCount = 0;
    ...
    public void setExpProductNotif(int expProductsNotifCount) { 

        this.emptyQuantityNotifCount = expProductsNotifCount;

    }

    public void setEmptyQuantityNotifCount(int emptyQuantityNotifCount) { 

        this.emptyQuantityNotifCount = emptyQuantityNotifCount;
    ...
    public int setExpiredProductCount() { 

        return expProductsNotifCount;
    }

    public int setEmptyQuantityNotifCount() { 

        return emptyQuantityNotifCount;
